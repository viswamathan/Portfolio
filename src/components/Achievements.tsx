...
const Achievements = () => {
  ...
  const specializations = [
    {
      ...
      thumbnail: "additive-manufacturing-thumbnail.png",
      allCertificates: [
  ...
  return (
    <div className="min-h-screen gradient-shift section-padding">
      <div className="container mx-auto">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-12">
            <div className="inline-flex items-center gap-2 glass-effect px-4 py-2 rounded-full border border-gray-700/40 mb-4">
              <Cpu className="w-4 h-4 text-purple-400" />
              <span className="text-sm text-gray-300">Technical Achievements</span>
            </div>

            <h2 className="hero-text font-bold mb-4">
              <span className="gradient-text">Engineering</span>
              <br />
              <span className="gradient-text">Certifications</span>
            </h2>

            <p className="text-gray-400 text-lg max-w-3xl mx-auto content-text">
          ...
          <motion.div variants={itemVariants} className="mb-16">
            <div className="flex items-center justify-between mb-6">
              <h3 className="subsection-heading text-white">Specialization Portfolio</h3>
              <div className="flex items-center gap-2 text-gray-400">
                <BookOpen className="w-5 h-5" />
                <span className="small-text">{specializations.length} Specializations</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
              {specializations.map((spec, index) => {
                ...
                return (
                  ...
                  >
                    {/* Thumbnail Header */}
                    <div className={`p-5 bg-gradient-to-r ${spec.color}`}>
                      ...
                      <h4 className="text-lg font-bold text-white mb-1">{spec.title}</h4>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-3">
                        ...
                        <motion.button
                          className="px-4 py-3 border border-gray-600 text-gray-300 rounded-lg transition-all duration-300"
                          whileHover={{ scale: 1.03 }}
                          whileTap={{ scale: 0.98 }}
                          onClick={() => {
          ...
          <motion.div variants={itemVariants} className="mb-16">
            ...
            {certificates.map((cert) => (
              <motion.div
                key={cert.id}
                className="card mb-6 border-purple-500/10"
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="relative w-full flex items-center justify-center p-6">
                    ...
                    >
                      ...
                      />
                      <div className="absolute inset-0 bg-purple-500/8 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    </motion.div>
                  </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h4 className="text-2xl font-bold text-white mb-1">{cert.title}</h4>
                        <p className="text-purple-400 font-medium">{cert.issuer}</p>
                      </div>
                      <div className="text-right">
                        <div className="px-3 py-1 rounded-full text-xs border bg-green-500/10 text-green-400 border-green-500/20">
                    ...
                    <p className="text-gray-300 mb-4 content-text">{cert.description}</p>

                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        <h5 className="font-semibold text-purple-300 mb-1">Issue Date</h5>
                      ...
                      <div>
                        <h5 className="font-semibold text-purple-300 mb-1">Level</h5>
                        <span className="text-gray-300">{cert.level}</span>
                      </div>
                      <div>
                        <h5 className="font-semibold text-purple-300 mb-1">Credential ID</h5>
                        <span className="text-gray-300 font-mono text-sm">{cert.credentialId}</span>
                      </div>
                      <div>
                        <h5 className="font-semibold text-purple-300 mb-1">Valid Until</h5>
                        <span className="text-gray-300">{cert.validUntil}</span>
                      </div>
                    </div>

                    <div className="mb-4">
                      <h5 className="font-semibold text-purple-300 mb-2">Skills Validated</h5>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <motion.button
                        className="px-4 py-3 bg-gray-800 rounded-lg text-white flex items-center gap-2"
                        whileHover={{ scale: 1.03 }}
                        whileTap={{ scale: 0.98 }}
                        onClick={() => {
                          const link = document.createElement("a");
          ...
          <AnimatePresence>
            {lightboxOpen && (
              ...
              >
                <motion.div
                  className="relative glass-effect rounded-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden"
                ...
                >
                  ...
                  <div className="flex items-center justify-between p-6 border-b border-gray-700">
                    <div>
                      <h3 className="text-2xl font-bold text-white">{currentSpecialization.title}</h3>
                  ...
                  <div className="p-6">
                    <div className="grid lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        <h4 className="text-xl font-bold text-white mb-3">Course Curriculum</h4>
                  ...
                  <button
                    ...
                    className="absolute left-4 top-1/2 transform -translate-y-1/2 p-3 glass-effect hover:scale-105 rounded-full transition-all"
                    aria-label="Previous"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 p-3 glass-effect hover:scale-105 rounded-full transition-all"
                    aria-label="Next"
                  >
