...
},
{
  ...
  useEffect(() => {
    ...
    scene.background = new THREE.Color(0x1e1b2d); // purple tone
    ...
    <div className="container mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-10">
        {stats.map((stat, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`flex items-center gap-4 p-4 rounded-xl shadow-lg bg-gradient-to-r from-purple-600 to-purple-400 text-white`}
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredModels.map((model) => (
          <div
            key={model.title}
            className="bg-purple-900 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 flex flex-col"
          >
            <div className="relative h-48">
              ...
              <div className="absolute top-3 left-3 flex flex-col gap-2">
                <span className="flex items-center gap-1 px-2 py-1 bg-purple-700 rounded-full text-white text-xs">
            ...
            <div className="p-4 flex-1 flex flex-col justify-between">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {model.features.map((f, idx) => (
                    <span
                      key={idx}
                      className="text-xs px-2 py-1 bg-purple-700 text-white rounded-full"
                    >
                      {f}
                    </span>
                  ))}
              ...
              <div className="flex gap-2 mt-auto">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-purple-700 hover:bg-purple-600 rounded-lg text-white font-semibold text-sm"
                >
      ...
      {previewModel && (
        <div className="fixed inset-0 bg-black bg-opacity-95 z-50 flex items-center justify-center p-4">
          <div className="relative bg-purple-900 w-full max-w-6xl h-[750px] rounded-lg p-4 shadow-2xl">
            <button
            ...
            <div className="absolute bottom-5 left-5 flex gap-3">
              <button
                onClick={zoomIn}
                className="px-4 py-2 bg-purple-700 rounded-lg text-white flex items-center gap-1"
              >
                <ZoomIn /> Zoom In
              </button>
              <button
      ...
      {previewImage && (
        <div className="fixed inset-0 bg-black bg-opacity-95 z-50 flex items-center justify-center p-4">
          <div className="relative bg-purple-900 w-full max-w-4xl rounded-lg p-4 shadow-2xl">
            <button
