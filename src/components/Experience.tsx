  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      >
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-600">
        ...
        <VerticalTimeline lineColor="rgba(139, 92, 246, 0.3)">
          ...
          <VerticalTimelineElement
            ...
            date={
              <motion.div
                ...
                className="text-purple-400 font-semibold text-lg sm:text-xl"
              >
                June 2024 - July 2024
              </motion.div>
            }
          ...
          >
            <motion.div 
              className="relative flex flex-col lg:flex-row gap-6 group-hover:scale-[1.02] transition-transform duration-300"
              whileHover={{ scale: 1.01 }}
            >
              <div className="flex-1 z-10">
                <motion.h3 
                  className="text-2xl sm:text-3xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-600"
                  initial={{ opacity: 0 }}
                ...
                <motion.h4 
                  className="text-purple-400 mb-4 font-semibold text-xl"
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
                ...
                >
                  {[
                    ...
                    >
                      <ChevronRight className="w-5 h-5 text-purple-500 mt-1 flex-shrink-0 group-hover:translate-x-1 transition-transform" />
                ...
                >
                  <motion.button
                    ...
                    className="flex items-center gap-2 bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition-all shadow-lg hover:shadow-purple-500/25"
                  ...
                  <motion.button
                    ...
                    className="flex items-center gap-2 bg-gray-700 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition-all shadow-lg hover:shadow-gray-500/25"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
              ...
              <motion.div 
                className="relative flex flex-col items-center lg:items-end mt-6 lg:mt-0 lg:ml-8"
              ...
              >
                <motion.img
                  src="/NIOT_LOGO.png"
                  alt="NIOT Logo"
                  className="w-20 h-20 rounded-full border-2 border-purple-500 shadow-lg mb-6 hover:border-purple-400 transition-all"
