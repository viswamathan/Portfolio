...
const SimulationModal = ({ isOpen, onClose, simulations }) => {
  ...
  return (
    ...
    >
      <div className="bg-gray-900 rounded-lg max-w-5xl w-full max-h-[95vh] overflow-auto">
            ...
            {simulations.map((simulation, index) => (
              <div key={index} className="flex justify-center">
                <img
                  ...
                  className="w-full h-64 object-contain rounded-lg border-2 border-purple-500/30"
                />
              </div>
            ))}
          </div>
